...
local eff_dmg_note_rgb = iu_actit(" The more powerful the effect on the enemy, the more Damage they receive.", note_col)
local dmg_x_2_5_note_rgb = iu_actit(" Damage is 2.5 times higher.", note_col)
...
{	id = "trait_bespoke_6_desc_ext_en", -- Hammerblow
	...
	locales = {"en",}, handle_func = function(locale, value)
	return p_impact_var_rgb .. " " .. impact_rgb .. " for {#color(255, 255, 140)}3.5{#reset()} seconds on Hit. Stacks " .. stacks_var_rgb .. " times. Up to {#color(255, 255, 140)}5{#reset()} Stacks per Hit." end}, -- colors s->seconds -- {time:%s}=1.5
...
{	id = "trait_bespoke_8_desc_ext_en", -- Shred
	...
	locales = {"en",}, handle_func = function(locale, value)
	return p_crit_var_rgb .. " Bonus " .. crit_chance_rgb .. " on Chained Hit for {#color(255, 255, 140)}3.5{#reset()} seconds. Stacks " .. stacks_var_rgb .. " times." end}, -- colors Note! -- hidden "for 3.5 seconds"
...
{	id = "trait_bespoke_10_desc_ext_en", -- Exorcist
	...
	locales = {"en",}, handle_func = function(locale, value)
	return "Quell " .. warp_charge_var_rgb .. " of " .. peril_rgb .. " on Repeated " .. weakspot_rgb .. " Hit." end}, -- colors
...
{	id = "trait_bespoke_14_desc_ext_en", -- Uncanny Strike
	...
	locales = {"en",}, handle_func = function(locale, value)
	return p_rending_var_rgb .. " " .. rending_rgb .. " on Enemy " .. weakspot_rgb .. " Hit for " .. time_var_rgb .. " seconds. Stacks " .. stacks_var_rgb .. " times." .. rend_note_rgb end}, -- colors s->seconds
{	id = "trait_bespoke_15_desc_ext_en", -- Executor
	loc_keys = {"loc_trait_bespoke_chained_weakspot_hits_increases_power_desc",},
	locales = {"en",}, handle_func = function(locale, value)
	return p_pwr_lvl_var_rgb .. " " .. power_rgb .. " Level on Repeated " .. weakspot_rgb .. " Hit. Stacks " .. stacks_var_rgb .. " times." .. pwr_note_rgb end}, -- colors
...
{	id = "trait_bespoke_33_desc_ext_en", -- Lacerate
	...
	locales = {"en",}, handle_func = function(locale, value)
	return p_stacks_var_rgb .. " " .. bleed_rgb .. " Stacks on non-" .. weakspot_rgb .. " Hits. Up to {#color(255, 255, 140)}16{#reset()} Stacks." end}, -- colors
...
{	id = "trait_bespoke_39_desc_ext_en", -- Warp Nexus
	...
	locales = {"en",}, handle_func = function(locale, value)
	return "Gain between " .. crit_var_rgb .. " and " .. crit_chance_max_var_rgb .. " " .. crit_chance_rgb .. " based on current " .. peril_rgb .. " Level." end}, -- colors
...
{	id = "trait_bespoke_44_desc_ext_en", -- Transfer Peril
	...
	locales = {"en",}, handle_func = function(locale, value)
	return "Quell " .. warp_charge_var_rgb .. " of your " .. peril_rgb .. " on " .. weakspot_rgb .. " Hit." .. trauma_note_rgb end}, -- colors
...
{	id = "trait_bespoke_55_desc_ext_en", -- Ghost
	...
	locales = {"en",}, handle_func = function(locale, value)
	return "Immune to Ranged Attacks for " .. time_var_rgb .. " seconds on " .. weakspot_rgb .. " Hit." end}, -- colors
{	id = "trait_bespoke_56_desc_ext_en", -- Falter
	loc_keys = {"loc_trait_bespoke_negate_stagger_reduction_on_weakspot_desc",},
	locales = {"en",}, handle_func = function(locale, value)
	return p_stgr_var_rgb .. " Target " .. stagger_rgb .. " on " .. weakspot_rgb .. " Hit." end}, -- colors
...
{	id = "trait_bespoke_58_desc_ext_en", -- No Respite
	...
	locales = {"en",}, handle_func = function(locale, value)
	return "Up to " .. p_dmg_var_rgb .. " " .. damage_rgb .. " on Hit to " .. staggered_rgb .. " Enemy." .. eff_dmg_note_rgb end}, -- colors
{	id = "trait_bespoke_59_desc_ext_en", -- Between the Eyes
	loc_keys = {"loc_trait_bespoke_suppression_negation_on_weakspot_desc",},
	locales = {"en",}, handle_func = function(locale, value)
	return "Gain Suppression Immunity for " .. time_var_rgb .. " seconds on " .. weakspot_rgb .. " Hit." end}, -- colors s->seconds
...
{	id = "trait_bespoke_61_desc_ext_en", -- Headhunter
	...
	locales = {"en",}, handle_func = function(locale, value)
	return p_crit_var_rgb .. " " .. crit_chance_rgb .. " on " .. weakspot_rgb .. " Hit until your next " .. crit_hit_rgb .. ". Stacks " .. stacks_var_rgb .. " times." end}, -- colors
...
{	id = "trait_bespoke_65_desc_ext_en", -- Deathspitter
	...
	locales = {"en",}, handle_func = function(locale, value)
	return p_pwr_lvl_var_rgb .. " " .. power_rgb .. " on Kill at a distance of up to {#color(255, 255, 140)}8{#reset()} meters for " .. time_var_rgb .. " seconds. Stacks {#color(255, 255, 140)}5{#reset()} times." .. pwr_note_rgb end}, -- colors Note!
...
{	id = "trait_bespoke_67_desc_ext_en", -- Dumdum
	...
	locales = {"en",}, handle_func = function(locale, value)
	return p_dmg_var_rgb .. " " .. damage_rgb .. " on Repeated Hit. Stacks " .. stacks_var_rgb .. " times." .. dmg_dist_note_rgb end}, -- colors -- "Close Range"->"ALL Range!"
...
{	id = "trait_bespoke_70_desc_ext_en", -- Infernus
	...
	locales = {"en",}, handle_func = function(locale, value)
	return p_stacks_var_rgb .. " " .. burning_rgb .. " Stacks on " .. crit_hit_rgb .. " to a maximum of " .. max_stacks_var_rgb .. " Stacks." end}, -- colors ()
...
{	id = "trait_bespoke_73_desc_ext_en", -- Trickshooter
	...
	locales = {"en",}, handle_func = function(locale, value)
	return p_pwr_lvl_var_rgb .. " " .. power_rgb .. " on Chained " .. weakspot_rgb .. " Hit to Any Target. Stacks " .. stacks_var_rgb .. " times." .. pwr_note_rgb end}, -- colors
...
{	id = "trait_bespoke_87_desc_ext_en", -- Shattering Impact
	...
	locales = {"en",}, handle_func = function(locale, value)
	return "Target receives " .. stacks_var_rgb .. " Stacks of {#color(255, 255, 140)}{rending:%s}{#reset()} " .. brittleness_rgb .. " on direct projectile hit. Lasts " .. time_var_rgb .. " seconds." .. brtl_note_rgb end}, -- colors s->seconds
...
{	id = "trait_bespoke_92_desc_ext_en", -- Gets Hot!
	...
	locales = {"en",}, handle_func = function(locale, value)
	return "Up to " .. p_crit_var_rgb .. " " .. crit_chance_rgb .. ". Scales with increasing Heat level." end}, -- colors -- "(scales on Heat Level)" -> "Scales with increasing Heat level."
-- ____________________________________________________Helbore Lasgun
{	id = "trait_bespoke_93_desc_ext_en", -- Onslaught
...
{	id = "trait_bespoke_101_desc_ext_en", -- Ceaseless Barrage
	...
	locales = {"en",}, handle_func = function(locale, value)
	return p_spprsn_var_rgb .. " Suppression for every " .. ammo_var_rgb .. " of magazine spent during continuous fire. Stacks " .. stacks_var_rgb .. " times." end}, -- colors
...
{	id = "trait_bespoke_102_desc_ext_en", -- Can opener
	...
	locales = {"en",}, handle_func = function(locale, value)
	return "Target receives " .. stacks_var_rgb .. " stacks of " .. p_rending2_var_rgb .. " " .. brittleness_rgb .. " on weapon Special Hit. Lasts " .. time_var_rgb .. " seconds. " .. brtl_note_rgb end}, -- colors s->seconds
...
{	id = "curio_traits9_ext_en",
	...
	locales = {"en",}, handle_func = function(locale, value)
	return m_tghn_reg_del_rgb .. " " .. toughness_rgb .. " Regeneration Delay" end},
