...
if enhanced_descriptions_enabled then
	TALENTS_Enh_desc = mod:io_dofile("ENLocalizationFIXAIO/scripts/mods/ENLocalizationFIXAIO/TALENTS_Enh_desc")
else
	TALENTS_Enh_desc = mod:io_dofile("ENLocalizationFIXAIO/scripts/mods/ENLocalizationFIXAIO/NULL/TALENTS_Enh_desc_null")
end
...
if enhanced_descriptions_enabled2 then
	TALENTS_Enh_desc2 = mod:io_dofile("ENLocalizationFIXAIO/scripts/mods/ENLocalizationFIXAIO/TALENTS_Enh_desc2")
else
	TALENTS_Enh_desc2 = mod:io_dofile("ENLocalizationFIXAIO/scripts/mods/ENLocalizationFIXAIO/NULL/TALENTS_Enh_desc2_null")
end
...
if enhanced_descriptions_nodes_enabled then
	TALENTS_Enh_desc_nodes = mod:io_dofile("ENLocalizationFIXAIO/scripts/mods/ENLocalizationFIXAIO/TALENTS_Enh_desc_nodes")
else
	TALENTS_Enh_desc_nodes = mod:io_dofile("ENLocalizationFIXAIO/scripts/mods/ENLocalizationFIXAIO/NULL/TALENTS_Enh_desc_nodes_null")
end
