...
COLORS_KWords = mod:io_dofile("ENLocalizationFIXAIO/scripts/mods/ENLocalizationFIXAIO/COLORS_KWords")
COLORS_Numbers = mod:io_dofile("ENLocalizationFIXAIO/scripts/mods/ENLocalizationFIXAIO/COLORS_Numbers")
...
--[+ +PASSIVES+ +]--
	...
	create_template("talent_tree_vet_pas_002_desc_en", {"loc_talent_veteran_toughness_damage_reduction_per_ally_description"}, {"en"}, function(locale, value) return "Up to {toughness:%s} "..COLORS_KWords.Toughness_dmg_red_rgb.." the more Allies in Coherency."..TALENTS_Enh_desc2.ED_VET_Passive_2_rgb end), -- toughness: +33% -- colors
	...
	create_template("talent_tree_vet_pas_014_desc_en", {"loc_talent_veteran_hits_cause_bleed_desc"}, {"en"}, function(locale, value) return "{stacks:%s} Stack of "..COLORS_KWords.Bleed_rgb.." to the target on Melee Hit."..TALENTS_Enh_desc2.ED_VET_Passive_14_rgb end), -- stacks: 1 -- Stack(s)->Stacks -- colors
...
--[+ +ABILITIES+ +]--
	...
	create_template("talent_tree_ogr_abil3_000_desc_en", {"loc_talent_ogryn_combat_ability_special_ammo_desc"}, {"en"}, function(locale, value) return "Swaps to and reloads your Ranged Weapon. For the next {duration:%s} seconds you have {ranged_attack_speed:%s} Rate of Fire and {reload_speed:%s} Reload Speed. Base Cooldown {cooldown:%s} seconds."..TALENTS_Enh_desc2.ED_OGR_Ability_3_rgb end), -- ranged_attack_speed: +25%, reload_speed: +70%, duration: 10, cooldown: 80 -- s->seconds
...
--[+ +KEYSTONES+ +]--
	...
	create_template("talent_tree_ogr_keys3_003_desc_en", {"loc_talent_ogryn_increased_leadbelcher_chance_desc"}, {"en"}, function(locale, value) return "Your chance of triggering "..COLORS_KWords.Lucky_bullet_rgb.." is increased to {proc_chance:%s}. Up to "..COLORS_Numbers.n_10_rgb.." Stacks." end), -- proc_chance: 12% -- rewrite -- colors
