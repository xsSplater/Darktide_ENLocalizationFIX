...
return {
	Scriers_gaze_rgb = Scriers_gaze_rgb, Stun_gren_rgb = Stun_gren_rgb, Fury_rgb = Fury_rgb, Frag_gren_rgb = Frag_gren_rgb, Fragmentation_gren_rgb = Fragmentation_gren_rgb,

	stacks_var_rgb = stacks_var_rgb, rending_pc_var_rgb = rending_pc_var_rgb, stacks_num_var_rgb = stacks_num_var_rgb, time_var_rgb = time_var_rgb, ammo_var_rgb = ammo_var_rgb, block_var_rgb = block_var_rgb, blltam_var_rgb = blltam_var_rgb, chnc_var_rgb = chnc_var_rgb, chrgtime_var_rgb = chrgtime_var_rgb, cd_var_rgb = cd_var_rgb, cd_dur_var_rgb = cd_dur_var_rgb, cleave_var_rgb = cleave_var_rgb, crit_var_rgb = crit_var_rgb, critchmax_var_rgb = critchmax_var_rgb, critchmin_var_rgb = critchmin_var_rgb, dmg_var_rgb = dmg_var_rgb, dur_var_rgb = dur_var_rgb, hit_var_rgb = hit_var_rgb, hit_mass_red_var_rgb = hit_mass_red_var_rgb, impact_var_rgb = impact_var_rgb, maxstks_var_rgb = maxstks_var_rgb, max_stk_cnt_var_rgb = max_stk_cnt_var_rgb, min_stk_cnt_var_rgb = min_stk_cnt_var_rgb, mult_hit_var_rgb = mult_hit_var_rgb, procch_var_rgb = procch_var_rgb, pwr_var_rgb = pwr_var_rgb, pwrlvl_var_rgb = pwrlvl_var_rgb, red_var_rgb = red_var_rgb, reload_var_rgb = reload_var_rgb, rending2_var_rgb = rending2_var_rgb, range_var_rgb = range_var_rgb, rangcrtdmg_var_rgb = rangcrtdmg_var_rgb, rend_var_rgb = rend_var_rgb, stgr_var_rgb = stgr_var_rgb, stgrrang_var_rgb = stgrrang_var_rgb, stgrrdct_var_rgb = stgrrdct_var_rgb, stam_var_rgb = stam_var_rgb, tghns_var_rgb = tghns_var_rgb, value_var_rgb = value_var_rgb, warpchrg_var_rgb = warpchrg_var_rgb, weapsprd_var_rgb = weapsprd_var_rgb,

	m_tghn_reg_del_rgb = m_tghn_reg_del_rgb, p_stam_var_rgb = p_stam_var_rgb, p_rbc_rgb = p_rbc_rgb, p_chrgspd_var_rgb = p_chrgspd_var_rgb, p_dmgcls_var_rgb = p_dmgcls_var_rgb, p_clv_var_rgb = p_clv_var_rgb, p_crit_var_rgb = p_crit_var_rgb, p_critdmg_var_rgb = p_critdmg_var_rgb, p_critwkspdmg_var_rgb = p_critwkspdmg_var_rgb, p_dmg_var_rgb = p_dmg_var_rgb, p_dmgnr_var_rgb = p_dmgnr_var_rgb, p_explosion_rad_var_rgb = p_explosion_rad_var_rgb, p_xtrahits_var_rgb = p_xtrahits_var_rgb, p_dmghvy_var_rgb = p_dmghvy_var_rgb, p_hitmass_var_rgb = p_hitmass_var_rgb, p_dmgvsprsd_var_rgb = p_dmgvsprsd_var_rgb, p_dmgvsstgr_var_rgb = p_dmgvsstgr_var_rgb, p_dmgvogrmon_var_rgb = p_dmgvogrmon_var_rgb, p_fin_var_rgb = p_fin_var_rgb, p_imp_var_rgb = p_imp_var_rgb, p_impmod_var_rgb = p_impmod_var_rgb, p_mel_weapsp_dmg_var_rgb = p_mel_weapsp_dmg_var_rgb, p_movspd_var_rgb = p_movspd_var_rgb, p_radius_var_rgb = p_radius_var_rgb, p_pwr_var_rgb = p_pwr_var_rgb, p_pwrlvl_var_rgb = p_pwrlvl_var_rgb, p_procch_var_rgb = p_procch_var_rgb, p_reload_var_rgb = p_reload_var_rgb, p_rend_var_rgb = p_rend_var_rgb, p_rending_var_rgb = p_rending_var_rgb, p_stacks_var_rgb = p_stacks_var_rgb, p_stgr_var_rgb = p_stgr_var_rgb, p_spprsn_var_rgb = p_spprsn_var_rgb, p_tghns_var_rgb = p_tghns_var_rgb, p_wkspdmg_var_rgb = p_wkspdmg_var_rgb, m_hitmass_var_rgb = m_hitmass_var_rgb, m_heat_pc_var_rgb = m_heat_pc_var_rgb, m_movspd_var_rgb = m_movspd_var_rgb, m_recoil_red_var_rgb = m_recoil_red_var_rgb, p_abil_cd_rgb = p_abil_cd_rgb, p_blckcst_rgb = p_blckcst_rgb, p_corr_rgb = p_corr_rgb, p_corrgrm_rgb = p_corrgrm_rgb, p_credits_rgb = p_credits_rgb, p_dmg_red_rgb = p_dmg_red_rgb, p_gears_rgb = p_gears_rgb, p_maxhlth_rgb = p_maxhlth_rgb, p_maxstam_rgb = p_maxstam_rgb, p_maxtghns_rgb = p_maxtghns_rgb, p_maxwnds_rgb = p_maxwnds_rgb, p_revive_rgb = p_revive_rgb, p_stamreg_rgb = p_stamreg_rgb, p_tghn_reg_del_rgb = p_tghn_reg_del_rgb, p_xp_rgb = p_xp_rgb, m_bcm_rgb = m_bcm_rgb,

	n_plus_rgb = n_plus_rgb, n_minus_rgb = n_minus_rgb, n_0_rgb = n_0_rgb, n_033_rgb = n_033_rgb, n_1_rgb = n_1_rgb, n_1_5_rgb = n_1_5_rgb, n_1_7_rgb = n_1_7_rgb, n_2_rgb = n_2_rgb, n_2_5_rgb = n_2_5_rgb, n_3_rgb = n_3_rgb, n_3_5_rgb = n_3_5_rgb, n_3_75_rgb = n_3_75_rgb, n_4_rgb = n_4_rgb, n_5_rgb = n_5_rgb, n_6_rgb = n_6_rgb, n_7_rgb = n_7_rgb, n_8_rgb = n_8_rgb, n_10_rgb = n_10_rgb, n_12_rgb = n_12_rgb, n_12_5_rgb = n_12_5_rgb, n_15_rgb = n_15_rgb, n_16_rgb = n_16_rgb, n_25_rgb = n_25_rgb, n_40_rgb = n_40_rgb, n_50_rgb = n_50_rgb, n_200_rgb = n_200_rgb, n_340_rgb = n_340_rgb,

	pc_rgb = pc_rgb, pc_2_5_rgb = pc_2_5_rgb, pc_6_rgb = pc_6_rgb, pc_10_rgb = pc_10_rgb, pc_20_rgb = pc_20_rgb, pc_25_rgb = pc_25_rgb, pc_40_rgb = pc_40_rgb, pc_48_rgb = pc_48_rgb, pc_97_rgb = pc_97_rgb, pc_p10_rgb = pc_p10_rgb, pc_p12_rgb = pc_p12_rgb, pc_p19_rgb = pc_p19_rgb,
}