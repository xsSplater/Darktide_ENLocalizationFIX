...
--[+ ++WEAPON - BLESSINGS++ +]--
	...
	create_template("trait_bespoke_096_desc_ext_en", {"loc_trait_bespoke_double_shot_on_crit_and_crit_chance_desc"}, {"en"}, function(locale, value) return COLORS_Numbers.p_crit_var_rgb.." Ranged "..COLORS_KWords.Crit_chance_rgb..".\n"..COLORS_Numbers.value_var_rgb.." Shots on "..COLORS_KWords.Crit_hit_rgb.."." end), -- crit_chance: +5%, value: 2 -- rewrite -- colors
		--[+ Warp Flurry +]-- 
